(() => {
  const images = [
    ...
    ['logitech pebble mouse 2 m350s raton bluetooth silencioso', 'assets/products/logitech-m350s.jpg', 'Logitech Pebble Mouse 2 M350s']
  ];
  ...
  images.forEach(([name, src, alt]) => {
    ...
    art.innerHTML = `<img src="${src}?v=20260913-1" alt="${alt}" loading="eager" style="width:auto;height:auto;max-width:82%;max-height:82%;object-fit:contain;display:block;margin:auto">`;
